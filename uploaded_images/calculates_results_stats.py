...
# REVISED DATE: 8/15/2023
# PURPOSE: Create a function c that calculates the 
...
def calculates_results_stats(results_dic):
    ...
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_corre' 
                  'ct_breed'] / results_stats_dic['n_dogs_img'])*100 
    else:
